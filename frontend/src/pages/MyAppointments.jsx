            ...
            <div className="grid grid-cols-[1fr_2fr] gap-4 sm:flex sm:gap-6 py-2 border-b border-gray-300" key={idx}>
              ...
              <div className="flex-1 text-sm text-zinc-600">
                ...
                <p className="text-sm mt-1">
                  {" "}
                  <span className="text-sm font-medium text-neutral-700">Date & Time:</span> 19 Nov, 2025 | 1:56 AM{" "}
                </p>
              </div>

              <div></div>
              <div className="flex flex-col gap-2 justify-end">
                <button className="text-sm text-stone-500 text-center sm:min-w-48 py-2 border rounded hover:bg-emerald-400 hover:text-white transition-all duration-300 cursor-pointer">Pay Online</button>
